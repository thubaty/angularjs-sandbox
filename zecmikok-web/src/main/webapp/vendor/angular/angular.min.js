...
(function (N, U, r) {
    ...
    function q(b, a, c) {
        var d, e;
        if (b)if (M(b))for (d in b)"prototype" == d || ("length" == d || "name" == d || b.hasOwnProperty && !b.hasOwnProperty(d)) || a.call(c, b[d], d); else if (L(b) || db(b))for (d = 0, e = b.length; d < e; d++)a.call(c, b[d], d); else if (b.forEach && b.forEach !== q)b.forEach(a, c); else for (d in b)b.hasOwnProperty(d) && a.call(c, b[d], d);
        return b
    }
    ...
    function Aa(b, a, c, d) {
        ...
        if (a) {
            ...
            if (L(b))for (var f =
                a.length = 0; f < b.length; f++)e = Aa(b[f], null, c, d), S(b[f]) && (c.push(b[f]), d.push(e)), a.push(e); else {
                var g = a.$$hashKey;
                q(a, function (b, c) {
                    delete a[c]
                });
                for (f in b)b.hasOwnProperty(f) && (e = Aa(b[f], null, c, d), S(b[f]) && (c.push(b[f]), d.push(e)), a[f] = e);
                Zb(a, g)
            }
        } else if (a = b)L(b) ? a = Aa(b, [], c, d) : ra(b) ? a = new Date(b.getTime()) : fb(b) ? a = RegExp(b.source) : S(b) && (e = Object.create(Object.getPrototypeOf(b)), a = Aa(b, e, c, d));
        return a
    }
    ...
    function sa(b, a) {
        ...
        if (c == typeof a && "object" == c)if (L(b)) {
            ...
            if (b && b.$evalAsync && b.$watch || a && a.$evalAsync &&
                a.$watch || Oa(b) || Oa(a) || L(a))return !1;
            c = {};
            for (d in b)if ("$" !== d.charAt(0) && !M(b[d])) {
                if (!sa(b[d], a[d]))return !1;
                c[d] = !0
            }
            for (d in a)if (!c.hasOwnProperty(d) && "$" !== d.charAt(0) && a[d] !== r && !M(a[d]))return !1;
            return !0
        }
        return !1
    }
    ...
    function Ab(b, a) {
        ...
        return !M(a) || a instanceof RegExp ? a : c.length ? function () {
            return arguments.length ?
                a.apply(b, c.concat(la.call(arguments, 0))) : a.apply(b, c)
        } : function () {
    ...
    function dc(b) {
        ...
        q((b || "").split("&"), function (b) {
            b && (c = b.split("="), d = cc(c[0]), F(d) && (b = F(c[1]) ? cc(c[1]) : !0, Bb.call(a, d) ? L(a[d]) ? a[d].push(b) : a[d] = [a[d], b] : a[d] = b))
        });
        return a
    }
    ...
    function pd(b, a) {
        var c, d, e = ec.length;
        b = C(b);
        for (d = 0; d < e; ++d)if (c = ec[d] + a, x(c = b.attr(c)))return c;
        return null
    }
    ...
    function qd(b, a) {
        ...
        var d = [b], e, f, g = {}, h = ["ng:app", "ng-app",
            "x-ng-app", "data-ng-app"], m = /\sng[:\-]app(:\s*([\w\d_]+);?)?\s/;
        q(h, function (a) {
            h[a] = !0;
    ...
    function sd() {
        ...
        (ua = N.jQuery) && ua.fn.on ? (C = ua, A(ua.fn, {
            ...
            for (var c = 0, d; null != (d = a[c]); c++)ua(d).triggerHandler("$destroy");
            b(a)
    ...
    function Q(b) {
        ...
        if (!(this instanceof Q)) {
            if (x(b) && "<" != b.charAt(0))throw Hb("nosel");
            return new Q(b)
        }
        if (x(b)) {
            var a;
    ...
    function qc(b, a) {
        ...
        d && (a ? delete Wa[c].data[a] :
            (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), rc(b)), delete Wa[c], b.ng339 = r))
    }

    function ma(b, a, c) {
        var d = b.ng339, d = Wa[d || -1];
        if (F(c))d || (b.ng339 = d = ++Le, d = Wa[d] = {}), d[a] = c; else return d && d[a]
    }
    ...
    function Kb(b, a, c) {
        ...
        if ("function" === typeof b) {
            if (!(d = b.$inject)) {
                d = [];
                if (b.length) {
                    if (a)throw x(c) && c || (c = b.name || Oe(b)), Ka("strictdi", c);
    ...
    function Db(b, a) {
        function c(a) {
            return function (b,
                             c) {
                if (S(b))q(b, Yb(a)); else return a(b, c)
            }
        }

        function d(a, b) {
            Ca(a, "service");
            if (M(b) || L(b))b = k.instantiate(b);
        ...
        function f(a) {
            ...
            q(a, function (a) {
                ...
                if (!n.get(a)) {
                    n.put(a, !0);
                    try {
                        x(a) ? (c = Ta(a), b = b.concat(f(c.requires)).concat(c._runBlocks), d(c._invokeQueue), d(c._configBlocks)) : M(a) ? b.push(k.invoke(a)) : L(a) ? b.push(k.invoke(a)) :
                            Sa(a, "module")
                    } catch (e) {
    ...
    function Ee() {
        this.$get = ["$$rAF", "$timeout", function (b,
                                                    a) {
    ...
    function Re(b, a, c, d) {
        ...
        h.url = function (a, c) {
            ...
            if (a) {
                if (u != a)return u = a, d.history ? c ? n.replaceState(null, "", a) : (n.pushState(null, "", a), z.attr("href", z.attr("href"))) : (w = a, c ? l.replace(a) : l.href = a), h
            } else return w || l.href.replace(/%27/g,
                    "'")
        };
        var X = [], O = !1;
        h.onUrlChange = function (a) {
            if (!O) {
                ...
                if (d.hashchange)C(b).on("hashchange", g); else h.addPollFn(g);
                O = !0
            }
            X.push(a);
            return a
        ...
        h.cookies = function (a, b) {
            var d, e, f, g;
            if (a)b === r ? m.cookie = escape(a) + "=;path=" + V + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : x(b) && (d = (m.cookie = escape(a) + "=" + escape(b) + ";path=" + V).length + 1, 4096 < d && c.warn("Cookie '" +
            a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!")); else {
                if (m.cookie !== P)for (P = m.cookie, d = P.split("; "), T = {}, f = 0; f < d.length; f++)e = d[f], g = e.indexOf("="), 0 < g && (a = unescape(e.substring(0, g)), T[a] === r && (T[a] = unescape(e.substring(g + 1))));
                return T
            }
        };
            ...
            function b(b, d) {
                ...
                return a[b] = {
                    put: function (a, b) {
                        ...
                        if (!y(b))return a in m || g++, m[a] = b, g > l && this.remove(k.key), b
                    }, get: function (a) {
                        if (l <
                            Number.MAX_VALUE) {
                            var b = n[a];
    ...
    function hc(b, a) {
        ...
        this.directive = function l(a, e) {
            Ca(a, "directive");
            x(a) ? (Eb(e, "directiveFactory"), c.hasOwnProperty(a) || (c[a] = [], b.factory(a + d, ["$injector", "$exceptionHandler", function (b, d) {
                var e = [];
                q(c[a], function (c, f) {
                    try {
                        var g = b.invoke(c);
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache",
            "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, p, k, t, s, I, E, D, u, z, w) {
                ...
                function T(a, b, c, d, e, f) {
                    function g(a, c, d, e) {
                        ...
                        D = p = 0;
                        for (t = h.length; p < t; D++)k = s[D], c = h[p++], f = h[p++], l = C(k), c ? (c.scope ? (n = a.$new(), l.data("$scope", n)) : n = a, l = c.transcludeOnThisElement ? P(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? P(a, b) : null, c(f, n, k, d, l)) : f && f(a, k.childNodes, r, e)
                    }

                    for (var h = [], k, l, n, p, t = 0; t < a.length; t++)k = new Lb, l = V(a[t], [], k, 0 === t ? d : r, e), (f = l.length ? J(l, a[t], k, b, c, null, [], [], f) : null) && f.scope && O(C(a[t]), "ng-scope"),
                        k = f && f.terminal || !(n = a[t].childNodes) || !n.length ? null : T(n, f ? (f.transcludeOnThisElement || !f.templateOnThisElement) && f.transclude : b), h.push(f, k), p = p || f || k, f = null;
                    return p ? g : null
                }
                        ...
                        case 1:
                            ...
                            for (var l, p, n, t = a.attributes, D = 0, s = t && t.length; D < s; D++) {
                                ...
                                if (!W ||
                                    ...
                                    p = aa(l.value);
                                    l = pa(k);
                                    if (n = Da.test(l))k = hb(l.substr(6), "-");
                                    var u = l.replace(/(Start|End)$/, "");
                                    l === u + "Start" && (E = k, I = k.substr(0, k.length - 5) + "end", k = k.substr(0, k.length - 6));
                                    l = pa(k.toLowerCase());
                                    h[l] = k;
                                    if (n || !c.hasOwnProperty(l))c[l] = p, wc(a, l) && (c[l] = !0);
                                    Z(a, b, p, l);
                                    va(b, l, "A", d, g, E, I)
                                }
                            }
                            a = a.className;
                            if (x(a) && "" !== a)for (; k = f.exec(a);)l = pa(k[2]), va(b, l, "C", d, g) && (c[l] = aa(k[3])), a = a.substr(k.index + k[0].length);
                            break;
                        case 3:
                            K(b, a.nodeValue);
                            break;
                        case 8:
                            try {
                                if (k = e.exec(a.nodeValue))l =
                                    pa(k[1]), va(b, l, "M", d, g) && (c[l] = aa(k[2]))
                            } catch (z) {
                            }
                    }
                    b.sort(y);
                ...
                function J(a, c, d, e, f, g, h, k, l) {
                    function t(a, b, c, d) {
                        if (a) {
                            ...
                            a.directiveName = A;
                            if (w ===
                                H || H.$$isolateScope)a = Cc(a, {isolateScope: !0});
                            h.push(a)
                        }
                        if (b) {
                            c && (b = $(b, c, d));
                            b.require = H.require;
                            b.directiveName = A;
                            if (w === H || H.$$isolateScope)b = Cc(b, {isolateScope: !0});
                            k.push(b)
                        }
                    }
                    ...
                    function E(a, e, f, g, l) {
                        ...
                        P && q(P, function (a) {
                            var b = {
                                $scope: a === w || a.$$isolateScope ? J : e, $element: z,
                                $attrs: u, $transclude: $
                            }, c;
                            X = a.controller;
                            "@" == X && (X = u[a.name]);
                    ...
                    for (var u = -Number.MAX_VALUE, z, P = l.controllerDirectives, w = l.newIsolateScopeDirective, T = l.templateDirective, J = l.nonTlbTranscludeDirective, va = !1, Ya = !1, y = l.hasElementTranscludeDirective, Z = d.$$element = C(c), H, A, R, K = e, G, N = 0, Q = a.length; N < Q; N++) {
                        ...
                        if (R = H.scope)H.templateUrl || (S(R) ? (La("new/isolated scope", w || z, H, Z), w = H) : La("new/isolated scope", w, H, Z)), z = z || H;
                        A = H.name;
                        !H.templateUrl && H.controller && (R = H.controller, P = P || {},
                            La("'" + A + "' controller", P[A], H, Z), P[A] = H);
                        if (R = H.transclude)va = !0, H.$$tlb || (La("transclusion", J, H, Z), J = H), "element" == R ? (y = !0, u = H.priority, R = v(c, Da, ob), Z = d.$$element = C(U.createComment(" " + A + ": " + d[A] + " ")), c = Z[0], pb(f, C(la.call(R, 0)), c), K = X(R, e, u, g && g.name, {nonTlbTranscludeDirective: J})) : (R = C(Ib(c)).contents(), Z.empty(), K = X(R, e));
                        if (H.template)if (Ya = !0, La("template", T, H, Z), T = H, R = M(H.template) ? H.template(Z, d) : H.template, R = Dc(R), H.replace) {
                            g = H;
                            R = Gb.test(R) ? C(Ec(H.type, aa(R))) : [];
                            c = R[0];
                            if (1 != R.length ||
                                1 !== c.nodeType)throw ia("tplrt", A, "");
                            pb(f, Z, c);
                            Q = {$attr: {}};
                            R = V(c, [], Q);
                        ...
                        if (H.templateUrl)Ya = !0, La("template", T, H, Z), T = H, H.replace && (g = H), E = B(a.splice(N, a.length - N), Z, d, f, va && K, h, k, {
                        ...
                        H.terminal &&
                        (E.terminal = !0, u = Math.max(u, H.priority))
                    }
                    E.scope = z && !0 === z.scope;
                ...
                function va(b, e, f, g, h, k, n) {
                    ...
                    if (c.hasOwnProperty(e)) {
                        var t;
                        e = a.get(e + d);
                        for (var D = 0, s = e.length; D < s; D++)try {
                ...
                function B(a, b, c, d, e, f, g, h) {
                    ...
                    k.get(u.getTrustedResourceUrl(z), {cache: t}).success(function (k) {
                        ...
                        if (s.replace) {
                            ...
                            t = k[0];
                            if (1 != k.length || 1 !== t.nodeType)throw ia("tplrt", s.name, z);
                            k = {$attr: {}};
                            pb(d, b, t);
                            var w = V(t, [], k);
                            S(s.scope) && F(w);
                ...
                function pb(a, b, c) {
                    ...
                    d = 1;
                    for (e = b.length; d < e; d++)f = b[d], C(f).remove(), a.appendChild(f),
                        delete b[d];
                    b[0] = c;
                    b.length = 1
                }
                ...
                Lb.prototype = {
                    $normalize: pa, $addClass: function (a) {
                        ...
                        f = na(this.$$element);
                        if ("a" === f && "href" === a || "img" === f && "src" === a)this[a] = b = w(b, "src" === a);
    ...
    function ke() {
        ...
        this.$get = ["$injector", "$window", function (d, e) {
            return function (f, g) {
                ...
                if (l) {
                    if (!g || "object" !== typeof g.$scope)throw K("$controller")("noscp", m || f.name, l);
                    g.$scope[l] = h
                }
                return h
            }
    ...
    function pe() {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, b,
                                                                                                             c, d, n, p) {
            function k(a) {
                function b(a) {
                ...
                var c = {
                    ...
                    a:for (f in c) {
                        a = G(f);
                        for (g in d)if (G(g) === a)continue a;
                        d[f] = c[f]
                    }
                    return d
                }(a);
            ...
            function t(c, f, m) {
                function p(a, b, c, e) {
                    V && (200 <= a && 300 > a ? V.put($, [a, b, Gc(c), e]) : V.remove($));
                    t(b, a, c, e);
                    d.$$phase || d.$apply()
                }
    ...
    function We(b) {
        if (8 >= W && (!b.match(/^(get|post|head|put|delete|options)$/i) || !N.XMLHttpRequest))return new N.ActiveXObject("Microsoft.XMLHTTP");
        ...
        return function (e, m, l, n, p, k, t, s) {
            ...
            if ("jsonp" == G(e)) {
                ...
                w.onreadystatechange = function () {
                    if (w && 4 == w.readyState) {
                        var a = null, b = null, c = "";
                        D !== g && (a = w.getAllResponseHeaders(), b = "response"in
                        w ? w.response : w.responseText);
            ...
            if (0 < k)var O = c(I, k); else k && k.then && k.then(I)
        }
    }
    ...
    function ne() {
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce", function (c, d, e) {
            ...
            function g(f, g, t, s) {
                s = !!s;
                for (var I, E, D = 0,
                         u = [], z = [], w = [], X = f.length, O = !1, T = !1, P = [], V = {}, v = {}; D < X;)if (-1 != (I = f.indexOf(b, D)) && -1 != (E = f.indexOf(a, I + h)))D !== I && (T = !0), u.push(f.substring(D, I)), D = f.substring(I + h, E), z.push(D), w.push(c(D)), D = E + m, O = !0; else {
                ...
                if (t && O && (T || 1 < z.length))throw Jc("noconcat", f);
                if (!g || O) {
                    P.length = u.length + z.length;
                    var $ = function (a) {
                        for (var b = 0, c = z.length; b < c; b++)P[2 * b] = u[b], P[2 * b + 1] = a[b];
                        P[2 *
                        c] = u[c];
                        return P.join("")
                    }, J = function (a) {
                    ...
                    return A(function oa(a) {
                        ...
                        return e
                    }, {exp: f, separators: u, expressions: z})
                }
            }
    ...
    function Qb(b, a) {
        ...
        this.$$parse = function (d) {
            var e = qa(b,
                    d) || qa(c, d), e = "#" == e.charAt(0) ? qa(a, e) : this.$$html5 ? e : "";
            if (!x(e))throw Pb("ihshprfx", d, a);
            Lc(e, this, b);
            d = this.$$path;
            var f = /^\/[A-Z]:(\/.*)/;
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function (c, d, e, f) {
            ...
            f.on("click", function (a) {
                if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
                    for (var e = C(a.target); "a" !== na(e[0]);)if (e[0] === f[0] || !(e = e.parent())[0])return;
                    var g = e.prop("href");
                    ...
                    l != d.url() && (h.$$parse(l), c.$apply(), N.angular["ff-684208-preventDefault"] = !0))
                }
            });
    ...
    function Ma(b, a) {
        if (b) {
            ...
            if (b.children &&
                (b.nodeName || b.prop && b.attr && b.find))throw ja("isecdom", a);
    ...
    function Pc(b, a, c) {
        ...
        if (1 === e)a = Ze(d[0], c); else if (2 === e)a = $e(d[0], d[1], c); else if (a.csp)a = 6 > e ? Oc(d[0], d[1], d[2], d[3], d[4], c) : function (a,
                                                                                                                                                        b) {
            var f = 0, l;
            do l = Oc(d[f++], d[f++], d[f++], d[f++], d[f++], c)(a, b), b = r, a = l; while (f < e);
            return l
        }; else {
            var f = "var p;\n";
            q(d, function (a, b) {
        ...
        this.$get = ["$filter", "$sniffer", function (c, d) {
            ...
            return function (d) {
                function f(a) {
                    function b(e, f) {
                        c || (d = a.constant &&
                        d ? d : a(e, f), b.$$unwatch = F(d), b.$$unwatch && (e && e.$$postDigestQueue) && e.$$postDigestQueue.push(function () {
    ...
    function Qc(b, a) {
            ...
            return n = {
                resolve: function (a) {
                    if (g) {
                        ...
                        l = f(a);
                        c.length && b(function () {
                            for (var a, b = 0, d = c.length; b < d; b++)a = c[b], l.then(a[0], a[1],
                                a[2])
                        })
                    }
                }, reject: function (a) {
        ...
        return {
            defer: e, reject: g, when: function (h, l, n, p) {
            ...
            h.prototype = {
                constructor: h, $new: function (a) {
                    ...
                    function c() {
                        e = m(d);
                        var a, b;
                        if (S(e))if (db(e))for (g !== n && (g = n, v = g.length = 0, l++), a = e.length, v !== a && (l++, g.length = v = a), b = 0; b < a; b++)g[b] !== g[b] && e[b] !== e[b] || g[b] === e[b] || (l++, g[b] = e[b]); else {
                            g !== p && (g = p = {}, v = 0, l++);
                            a = 0;
                            for (b in e)e.hasOwnProperty(b) && (a++, g.hasOwnProperty(b) ? g[b] !== e[b] && (l++, g[b] = e[b]) : (v++, g[b] = e[b], l++));
                            if (v > a)for (b in l++, g)g.hasOwnProperty(b) && !e.hasOwnProperty(b) && (v--, delete g[b])
                        } else g !== e && (g = e, l++);
                        c.$$unwatch = m.$$unwatch;
                        return l
                    }
                    ...
                    return this.$watch(c, function () {
                        ...
                        } else for (a in h = {}, e)Bb.call(e, a) && (h[a] = e[a]); else h = e
                    })
                }, $digest: function () {
                    ...
                    do {
                        ...
                        for (O = this; l.length;) {
                            try {
                                F =
                                    l.shift(), F.scope.$eval(F.expression)
                            } catch (J) {
                                k.$$phase = null, e(J)
                            }
                            c = null
                        ...
                        a:do {
                            if (h = O.$$watchers)for (z = h.length; z--;)try {
                                if (d = h[z])if ((f = d.get(O)) !== (g = d.last) && !(d.eq ? sa(f, g) : "number" === typeof f && "number" === typeof g && isNaN(f) && isNaN(g)))q = !0, c = d, d.last = d.eq ? Aa(f, null) : f, d.fn(f, g === p ? f : g, O), 5 > r && (C = 4 - r, T[C] || (T[C] = []), v = M(d.exp) ? "fn: " + (d.exp.name || d.exp.toString()) : d.exp, v += "; newVal: " + ta(f) + "; oldVal: " + ta(g), T[C].push(v)), d.get.$$unwatch && P.push({
                                    watch: d,
                                    array: h
                                }); else if (d === c) {
                                    q = !1;
                            ...
                            if (!(z = O.$$childHead || O !== this && O.$$nextSibling))for (; O !== this && !(z = O.$$nextSibling);)O = O.$parent
                        } while (O = z);
                        if ((q || l.length) && !r--)throw k.$$phase = null, a("infdig", b, ta(T));
                    } while (q || l.length);
                    for (k.$$phase = null; n.length;)try {
                        n.shift()()
                    } catch (B) {
                        e(B)
                    }
                    for (z = P.length - 1; 0 <= z; --z)d = P[z], d.watch.get.$$unwatch && Ga(d.array, d.watch)
                }, $destroy: function () {
                    if (!this.$$destroyed) {
                        var a = this.$parent;
                        this.$broadcast("$destroy");
                        this.$$destroyed = !0;
                        this !== k && (q(this.$$listenerCount, Ab(null, n, this)), a.$$childHead ==
                        this && (a.$$childHead = this.$$nextSibling), a.$$childTail == this && (a.$$childTail = this.$$prevSibling), this.$$prevSibling && (this.$$prevSibling.$$nextSibling = this.$$nextSibling), this.$$nextSibling && (this.$$nextSibling.$$prevSibling = this.$$prevSibling), this.$parent = this.$$nextSibling = this.$$prevSibling = this.$$childHead = this.$$childTail = this.$root = null, this.$$listeners = {}, this.$$watchers = this.$$asyncQueue = this.$$postDigestQueue = [], this.$destroy = this.$digest = this.$apply = B, this.$on = this.$watch = this.$watchGroup =
                            function () {
                                return B
                            })
                    }
    ...
    function xd() {
        ...
        this.$get = function () {
            return function (c, d) {
                var e = d ? a : b, f;
                if (!W || 8 <= W)if (f = wa(c).href, "" !== f && !f.match(e))return "unsafe:" + f;
                return c
            }
        }
    }
            ...
            return {
                trustAs: function (a, b) {
                    ...
                    if (c === ga.RESOURCE_URL) {
                        ...
                        n = 0;
                        for (p = b.length; n < p; n++)if ("self" === b[n] ? Mb(f) : b[n].exec(f.href)) {
                            k = !0;
                            break
                        }
                        if (k)for (n = 0, p = a.length; n <
                        p; n++)if ("self" === a[n] ? Mb(f) : a[n].exec(f.href)) {
                            k = !1;
                            break
                        }
                        if (k)return d;
        ...
        this.$get =
            ["$window", "$document", function (b, a) {
                ...
                if (l) {
                    ...
                    !d || n && p || (n = x(f.body.style.webkitTransition),
        ...
        return function (b, a, c) {
            ...
            "function" !== d && (c = "boolean" === d && c ? function (a, b) {
                ...
                if (a && b && "object" === typeof a && "object" === typeof b) {
                    for (var d in a)if ("$" !== d.charAt(0) && Bb.call(a, d) && c(a[d], b[d]))return !0;
                    return !1
                }
                b = ("" + b).toLowerCase();
    ...
    function Xc(b, a, c, d, e) {
        ...
        if (l)0 < e && (-1 < b && 1 > b) && (h = b.toFixed(e)); else {
            ...
            if (g.length >=
                p + k)for (n = g.length - p, l = 0; l < n; l++)0 === (n - l) % k && 0 !== l && (h += c), h += g.charAt(l);
    ...
    function Uc(b) {
        function a(a) {
            ...
            if (b = a.match(c)) {
                a = new Date(0);
                var f = 0, g = 0, h = b[8] ? a.setUTCFullYear : a.setFullYear, m = b[8] ? a.setUTCHours :
                    a.setHours;
        ...
        return function (c, e) {
            ...
            Fa(c) && (c = new Date(c));
            if (!ra(c))return c;
            for (; e;)(m = hf.exec(e)) ? (g = g.concat(la.call(m,
                1)), e = g.pop()) : (g.push(e), e = null);
            q(g, function (a) {
                h = jf[a];
    ...
    function ad(b, a, c, d) {
        ...
        f.$setValidity = function (a, b, c) {
            var d = m[a];
            if (b)d && (Ga(d, c), d.length || (h--, h || (e(b), f.$valid = !0, f.$invalid = !1), m[a] = !1, e(!0, a), g.$setValidity(a, !0, f))); else {
                h || e(b);
                if (d) {
                    if (-1 !=
                        Pa(d, c))return
    ...
    function ab(b, a, c, d, e, f) {
        ...
        var n = function (e) {
            if (!l) {
                ...
                if (W && "input" === (e || m).type && a[0].placeholder !== h)h = a[0].placeholder; else {
                    c.ngTrim && "false" === c.ngTrim || (f = aa(f));
                    var p = g && d.$$hasNativeValidators;
                    if (d.$viewValue !==
                        f || "" === f && p)b.$$phase ? d.$setViewValue(f, k, p) : b.$apply(function () {
    ...
    function zb(b, a) {
        return function (c) {
            var d;
            return ra(c) ? c : x(c) && (b.lastIndex = 0, c = b.exec(c)) ?
                (c.shift(), d = {yyyy: 0, MM: 1, dd: 1, HH: 0, mm: 0}, q(c, function (b, c) {
                    c < a.length && (d[a[c]] = +b)
    ...
    function cd(b, a, c, d, e) {
        if (F(d)) {
            b = b(d);
            if (!b.constant)throw(new K("ngModel"))("constexpr", "Expected constant expression for `{0}`, but saw `{1}`.", c, d);
            return b(a)
        }
        return e
    }
    ...
    function Vb(b, a) {
        ...
        return ["$animate", function (c) {
            function d(a, b) {
                ...
                a:for (; d < a.length; d++) {
                    for (var e = a[d], n = 0; n <
                    b.length; n++)if (e == b[n])continue a;
                    c.push(e)
                }
                return c
            }
    ...
    var ec = ["ng-", "data-ng-", "ng:", "x-ng-"], rd = /[A-Z]/g, vd = {
    ...
    var Ha = Q.prototype = {
        ...
        }, length: 0, push: tc, sort: [].sort, splice: [].splice
    }, nb = {};
    ...
    q({
        data: sc, inheritedData: mb, scope: function (b) {
            return C(b).data("$scope") || mb(b.parentNode || b, ["$isolateScope",
                    "$scope"])
            ...
            var d = G(a);
            if (nb[d])if (F(c))c ? (b[a] = !0, b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d));
            else return b[a] || (b.attributes.getNamedItem(a) || B).specified ? d : r; else if (F(c))b.setAttribute(a, c); else if (b.getAttribute)return b = b.getAttribute(a, 2), null === b ? r : b
        }, prop: function (b, a, c) {
            if (F(c))b[a] = c; else return b[a]
        }, text: function () {
            function b(a, b) {
                if (y(b)) {
                    var d = a.nodeType;
        ...
        Q.prototype[a] = function (a, d) {
            ...
            if (b !== vc && (2 == b.length && b !== Jb && b !== uc ? a : d) === r) {
                if (S(a)) {
                    for (e = 0; e < g; e++)if (b === sc)b(this[e], a); else for (f in a)b(this[e], f, a[f]);
                    return this
                }
                e = b.$dv;
    ...
    q({
        ...
        Q.prototype[c] = function (c, e, f) {
            for (var g, h = 0; h < this.length; h++)y(g) ? (g = a(this[h], c, e, f), F(g) && (g = C(g))) : pc(g, a(this[h], c, e, f));
            return F(g) ? g : this
        };
    ...
    var Ac = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Pe = /,/, Qe = /^\s*(_?)(\S+?)\1\s*$/, zc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Ka = K("$injector");
    Db.$$annotate = Kb;
    var nf = K("$animate"), he = ["$provide", function (a) {
        this.$$selectors = {};
    ...
    Rb.prototype = Qb.prototype = Mc.prototype = {
        $$html5: !1, $$replace: !1, absUrl: rb("$$absUrl"), url: function (a, c) {
            ...
            this.hash(d[5] || "", c);
            return this
        }, protocol: rb("$$protocol"), host: rb("$$host"), port: rb("$$port"), path: Nc("$$path", function (a) {
            ...
            switch (arguments.length) {
                case 0:
                    return this.$$search;
                case 1:
                    if (x(a))this.$$search = dc(a); else if (S(a))q(a, function (c, e) {
                        null == c && delete a[e]
                    }), this.$$search = a; else throw Pb("isrcharg");
                    break;
                default:
                    y(c) || null === c ? delete this.$$search[a] :
                        this.$$search[a] = c
            }
            this.$$compose();
            return this
        }, hash: Nc("$$hash", Ea), replace: function () {
            this.$$replace = !0;
            return this
        }
    };
    ...
    Tb.prototype = {
        constructor: Tb, lex: function (a) {
            ...
            else if (this.isNumber(this.ch) || this.is(".") && this.isNumber(this.peek()))this.readNumber(); else if (this.isIdent(this.ch))this.readIdent(); else if (this.is("(){}[].,;:?"))this.tokens.push({
                index: this.index,
                text: this.ch
            ...
            for (var d = "", e = a, f = !1; this.index < this.text.length;) {
                var g = this.text.charAt(this.index),
                    e = e + g;
                if (f)"u" === g ? (g = this.text.substring(this.index + 1, this.index + 5), g.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + g + "]"), this.index += 4, d += String.fromCharCode(parseInt(g, 16))) : d = (f = sf[g]) ? d + f : d + g, f = !1; else if ("\\" === g)f = !0; else {
                    if (g === a) {
                        this.index++;
                        this.tokens.push({
    ...
    $a.prototype = {
        constructor: $a, parse: function (a) {
            ...
            if (this.expect("("))a = this.filterChain(), this.consume(")"); else if (this.expect("["))a = this.arrayDeclaration(); else if (this.expect("{"))a = this.object(); else {
                var c = this.expect();
                (a = c.fn) || this.throwError("not a primary expression",
                    c);
            ...
            for (var a = this.expect(), c = this.$filter(a.text),
                     d = []; this.expect(":");)d.push(this.expression());
            ...
            var a;
            return this.expect("+") ? this.primary() : (a = this.expect("-")) ? this.binaryFn($a.ZERO,
                a.fn, this.unary()) : (a = this.expect("!")) ? this.unaryFn(a.fn, this.unary()) : this.primary()
            ...
            var e = this;
            return function (f, g) {
                for (var h = [], m = c ? c(f, g) : f, l = 0; l < d.length; l++)h.push(d[l](f, g));
                l = a(f, g, m) || B;
                Ma(m, e.text);
                var n = e.text;
                if (l) {
                    if (l.constructor === l)throw ja("isecfn", n);
                    if (l === pf || l === qf || l === rf)throw ja("isecff", n);
                }
        ...
        jb[c] = function () {
            return {
                priority: 99, link: function (d, e, f) {
                    var g = a, h = a;
                    "href" === a && "[object SVGAnimatedString]" === za.call(e.prop("href")) && (h = "xlinkHref", f.$attr[h] = "xlink:href",
                        g = null);
    ...
    var dd = function (a) {
        ...
        }, zd = dd(), Md = dd(!0), tf = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, uf = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, vf = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, ed = /^(\d{4})-(\d{2})-(\d{2})$/,
        fd = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)$/, Wb = /^(\d{4})-W(\d\d)$/, gd = /^(\d{4})-(\d\d)$/, hd = /^(\d\d):(\d\d)$/, wf = /(\s+|^)default(\s+|$)/, id = {
            text: ab,
            date: bb("date", ed, zb(ed, ["yyyy", "MM", "dd"]), "yyyy-MM-dd"),
            "datetime-local": bb("datetimelocal", fd, zb(fd, ["yyyy", "MM", "dd", "HH", "mm"]), "yyyy-MM-ddTHH:mm"),
            time: bb("time", hd, zb(hd, ["HH", "mm"]), "HH:mm"),
            week: bb("week", Wb, function (a) {
                ...
                if (x(a)) {
                    ...
                    if (c) {
                        ...
                        return new Date(a, 0, c.getDate() +
                        d)
                    }
                }
                return NaN
            }, "yyyy-Www"),
            month: bb("month", gd, zb(gd, ["yyyy", "MM"]), "yyyy-MM"),
            number: function (a, c, d, e, f, g) {
                ab(a, c, d, e, f, g);
                e.$parsers.push(function (a) {
                    var c = e.$isEmpty(a);
                    if (c || vf.test(a))return e.$setValidity("number", !0), "" === a ? null : c ? a : parseFloat(a);
            ...
            reset: B,
            file: B
        }, xf = ["badInput"], ic = ["$browser", "$sniffer", "$filter", "$parse", function (a, c, d, e) {
            return {
                restrict: "E", require: ["?ngModel"], link: function (f, g, h, m) {
                    m[0] && (id[G(h.type)] || id.text)(f, g, h, m[0], c, a, d, e)
                }
            }
        }], wb = "ng-valid", vb = "ng-invalid", Na = "ng-pristine", yb = "ng-dirty", yf = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", function (a, c, d, e, f, g, h) {
            function m(a,
                       c) {
                c = c ? "-" + hb(c, "-") : "";
            ...
            if (!n)throw K("ngModel")("nonassign", d.ngModel, ha(e));
            this.$render = B;
            this.$isEmpty = function (a) {
                return y(a) || "" === a || null === a || a !==
                    a
            };
            ...
            this.$$writeModelToScope = function () {
                var d;
                k.$options && k.$options.getterSetter && M(d = l(a)) ? d(k.$modelValue) :
                    n(a, k.$modelValue);
            ...
            a.$watch(function () {
                var c = l(a);
                k.$options && (k.$options.getterSetter &&
                M(c)) && (c = c());
            ...
            return {
                require: ["ngModel", "^?form", "^?ngModelOptions"], controller: yf, link: {
                ...
                require: "?ngModel", link: function (a, c, d, e) {
                    if (e) {
                        ...
                        d.$observe("pattern", function (a) {
                            ...
                            if (a && !a.test)throw K("ngPattern")("noregexp", g, a, ha(c));
                            f = a || r;
                            e.$validate()
                        });
            ...
            return {
                controller: ["$scope", "$attrs", function (a, c) {
                    ...
                    this.$options.updateOn !== r ? (this.$options.updateOnDefault = !1, this.$options.updateOn = aa(this.$options.updateOn.replace(wf,
                        function () {
    ...
    var Od = ["$animate", function (a) {
            return {
                ...
                link: function (c, d, e, f, g) {
                    ...
                    c.$watch(e.ngIf, function (c) {
                        ...
                        m && (m.$destroy(), m = null), h && (l = Fb(h.clone), a.leave(l, function () {
                            l = null
                        }), h = null))
                    })
                }
            }
        }], Pd = ["$http", "$templateCache", "$anchorScroll", "$animate", "$sce", function (a, c, d, e, f) {
            return {
                restrict: "ECA",
                priority: 400,
                terminal: !0,
        ...
        Qd = ya({
        ...
        }), Rd = ya({terminal: !0, priority: 1E3}), Sd = ["$locale", "$interpolate", function (a, c) {
            var d = /{}/g;
            return {
            ...
            return {
                transclude: "element", priority: 1E3, terminal: !0, $$tlb: !0, link: function (e, f, g, h, m) {
                    ...
                    e.$watchCollection(h, function (a) {
                        ...
                        if (db(a))B = a, A = k || t; else {
                            A = k || s;
                            B = [];
                            for (g in a)a.hasOwnProperty(g) && "$" != g.charAt(0) &&
                            B.push(g);
                            B.sort()
                        }
                        D = B.length;
                        g = x.length = B.length;
                        for (e = 0; e < g; e++)if (v = a === B ? e : B[e], F = a[v], J = A(v, F, e), Ca(J, "`track by` id"), u.hasOwnProperty(J))y = u[J], delete u[J], p[J] = y, x[e] = y; else {
                            if (p.hasOwnProperty(J))throw q(x, function (a) {
                                a && a.scope && (u[a.id] = a)
                            }), d("dupes", l, J);
                            x[e] = {id: J};
                            p[J] = !1
                        }
                        for (n in u)u.hasOwnProperty(n) && (y = u[n], g = Fb(y.clone), c.leave(g), q(g, function (a) {
                            a.$$NG_REMOVED = !0
                        }), y.scope.$destroy());
                        e = 0;
                        for (g = B.length; e < g; e++)if (v = a === B ? e : B[e], F = a[v], y = x[e], x[e - 1] && (h = x[e - 1].clone[x[e - 1].clone.length -
                            1]), y.scope) {
                            n = h;
            ...
            return {
                restrict: "EA", require: "ngSwitch", controller: ["$scope", function () {
                    ...
                    c.$watch(e.ngSwitch || e.on, function (d) {
                        var p, k;
                        p = 0;
                        for (k = m.length; p < k; ++p)m[p].remove();
                        p = m.length = 0;
            ...
            link: function (a, c, d, e, f) {
                if (!f)throw K("ngTransclude")("orphan", ha(c));
                f(function (a) {
                    c.empty();
                    c.append(a)
                })
            }
        }), Ad = ["$templateCache", function (a) {
            return {
                restrict: "E", terminal: !0, compile: function (c, d) {
                    "text/ng-template" == d.type && a.put(d.id, c[0].text)
                }
            }
        }], Af = K("ngOptions"), Zd = da({terminal: !0}), Bd = ["$compile", "$parse", function (a, c) {
                ...
                link: function (e, g, h, m) {
                    ...
                    function p(e, f, g) {
                        function h() {
                            ...
                            r = !1;
                            var G, K;
                            if (t)if (w && L(s))for (r = new Xa([]), A = 0; A < s.length; A++)x[m] =
                                s[A], r.put(w(e, x), s[A]); else r = new Xa(s);
                            for (A = 0; E = C.length, A < E; A++) {
                                ...
                                G = l(e, x);
                                G = F(G) ? G : "";
                                k.push({id: w ? w(e, x) : n ? C[A] : A, label: G, selected: d})
                            }
                            ...
                            for (C = c.length; x < C; x++) {
                                ...
                                G = null;
                                A = 0;
                                for (E = k.length; A < E; A++)r = k[A], (d = v[A + 1]) ? (G = d.element, d.label !== r.label && G.text(d.label = r.label), d.id !== r.id && G.val(d.id = r.id), d.selected !== r.selected && G.prop("selected", d.selected = r.selected)) : ("" === r.id && B ? K = B : (K = D.clone()).val(r.id).prop("selected", r.selected).text(r.label), v.push({
                                    element: K,
                                    label: r.label,
                                    id: r.id,
                                    selected: r.selected
                        ...
                        var k;
                        if (!(k = s.match(d)))throw Af("iexp", s, ha(f));
                        ...
                        f.on("change", function () {
                            e.$apply(function () {
                                ...
                                if (t)for (k = [], p = 0, u = y.length; p < u; p++)for (a = y[p], l = 1, s =
                                    a.length; l < s; l++) {
                                    ...
                                    h = f.val();
                                    if ("?" == h)k = r; else if ("" === h)k = null; else if (w)for (v = 0; v < c.length; v++) {
                                        if (d[m] = c[v], w(e, d) == h) {
                                            k = q(e, d);
                                            break
                                        }
                    ...
                    if (m[1]) {
                        var k = m[0];
                        m = m[1];
                        var t = h.multiple, s = h.ngOptions, B = !1, E, D = C(U.createElement("option")),
                            u = C(U.createElement("optgroup")), z = D.clone();
                        h = 0;
                        for (var w = g.children(), x = w.length; h < x; h++)if ("" === w[h].value) {
                            E = B = w.eq(h);
                            break
                        }
                        k.init(m, B, z);
